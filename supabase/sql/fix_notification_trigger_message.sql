-- =====================================================
-- FIX: on_notification_created refererade NEW.message
-- =====================================================
-- Tabellen notifications har `comment_text`, inte `message`.
-- Direkt åtkomst till NEW.message ger 42703 och blockerar
-- INSERT (likes, kommentarer, följningar).
-- Läs `message` via to_jsonb(NEW) så kolumnen kan saknas.
