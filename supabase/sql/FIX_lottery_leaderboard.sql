-- ============================================
-- FIX: LOTTERY LEADERBOARD FUNCTION
-- Problem: Total tickets räknas fel (inte samma som kortet)
-- Lösning: Inkludera ALLA användare i total, även de med 0
-- ============================================
...
BEGIN
    ...
    WITH user_tickets AS (
        SELECT 
            ...
            -- Gym tickets: count gym sessions with >5000kg volume
            COALESCE((
                WITH gym_volumes AS (
                    SELECT 
                        wp.id,
    ...
    -- ÄNDRING: Filtrera inte bort användare med 0, visa alla topp 20
...
-- ============================================
-- TEST: Kolla att det fungerar
-- ============================================
-- SELECT * FROM public.get_lottery_leaderboard(20);
