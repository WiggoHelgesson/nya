...
struct RaceDetailView: View {
    ...
    var body: some View {
                ...
                if isLoading {
                    ...
                    VStack(spacing: 12) {
                        Image(systemName: "photo.on.rectangle.angled")
                            .font(.system(size: 48))
                            .foregroundColor(.gray)
                        Text(isOwner ? L.t(sv: "Inga minnen ännu", nb: "Ingen minner ennå") : L.t(sv: "Inga minnen har lagts till", nb: "Ingen minner er lagt til"))
                            .font(.system(size: 16))
                            .foregroundColor(.gray)
                        if isOwner {
                            Text(L.t(sv: "Lägg till dina första minnen från denna resa", nb: "Legg til dine første minner fra denne reisen"))
                                .font(.system(size: 14))
        ...
        .navigationTitle(L.t(sv: "Tävling", nb: "Konkurranse"))
