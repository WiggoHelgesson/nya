        ...
        NavigationStack {
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    // MARK: - Kundtjänst & legalt Section
                    VStack(alignment: .leading, spacing: 8) {
                    ...
                    // MARK: - ADMIN Section (hidden for normal users)
                    if isAdmin {
                        VStack(alignment: .leading, spacing: 8) {
                            Text("Admin")
                                .font(.system(size: 13, weight: .medium))
